-- ============================================================
-- guia-crear-sin-destino-concurrencia.test.sql
...
--
-- Ambas sesiones crean una guía desde el MISMO origen (serie predeterminada
-- con siguiente_correlativo = 6) hacia un destino que NO tiene fila
-- ra_productos para el catálogo. Deben salir correlativos 6 y 7, distintos
-- y consecutivos; ninguna creación crea fila destino.
...
BEGIN
  ...
  v_o := md5('crsd-o-' || v_run)::uuid;
  v_d := md5('crsd-d-' || v_run)::uuid;
