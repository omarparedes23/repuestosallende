...
import { signInPanel } from '@/app/panel/actions/auth'

export default function PanelLoginPage() {
  const [error, formAction, isPending] = useActionState(signInPanel, null)
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-base" style={{ color: '#6B7280' }}>
            Repuestos Allende E.I.R.L. — Solo administradores
          </p>
        </div>
        ...
        <form action={formAction} className="space-y-5">
          <div className="space-y-2">
            <label htmlFor="email" className="block text-sm font-semibold" style={{ color: '#002D62' }}>
              Correo electrónico
            </label>
            <input
              id="email"
          ...
          <div className="space-y-2">
            <label htmlFor="password" className="block text-sm font-semibold" style={{ color: '#002D62' }}>
              Contraseña
            </label>
            <input
              id="password"
        ...
        <p className="text-center text-xs" style={{ color: '#9CA3AF' }}>
          Panel de gestión · Repuestos Allende S.A.C.
        </p>
      </div>
    </div>
  )
